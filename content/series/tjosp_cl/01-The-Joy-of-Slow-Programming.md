...
## The Great Big Slot Machine In the Sky

In the last three years AI has quickly revolutionized and changed the way that we think about work. With image generation untrained individuals can create posters, non-writers can write, and non-programmers can program. As such the tech industry boom of the 2018 to 2022 era quickly collapsed, resulting in a dearth of positions available for young and new developers.
...
With generative AI, people who “write” code no longer even need to understand it. But in this lack of understanding comes a lack of being able to properly own what you create. This isn’t to shame vibe-coders, I do it too, but rather to ask an important question: How can you understand something you don’t write? And how can you own it if you cannot grasp it?

## SlowGramming

In light of this, I’ve taken to what I love and refer to as “slowgramming.” Yes, it is just writing code like a normal person, I’ve decided to take it a step further: Using languages that are out of fashion or are no longer useful. LISP, SML, COBOL, and Smalltalk are good examples of such languages (and side note, COBOL is still HEAVILY used, it's just that people don’t exactly seek to become COBOL developers these days. They like keeping the hair on their head.)

But I am still a teacher at heart, and I want to give you, the viewer, something to have to follow along as well:  If you are a vibe coder, someone who slops out code and doesn’t quite fully understand what’s happening behind the scenes or you feel like something is missing in the joy of creating software, I want you to go on a journey with me to a time when programming was not the king it once was.

**Let us learn to once again enjoy The Art of Slow-Gramming.**
...
I intend for this series to be long-running and multipart, dedicated to helping you understand the joy of fully understanding what you create, deploy, and develop and why it works the way it does. Think of your education as a marathon. You may sprint your way to Y Combinator funding, but do not think that you can run a marathon just because you are Usain Bolt. You have potential, it is true, but to hone it takes a willingness to turn that potential into something more and a lot of time.

To help us on our journey, we will split this into 3 overarching parts.

### Part 1: Revisiting Abelson and Sussman

In this first part, we will revisit the old classic, the Structure and Interpretation of Computer Programs, and learn Common Lisp, the language of the 1950's. We will introduce the core concepts that underpin any computer program, system, or structure. You use them without thinking, reason without reasoning about them. Why not take the time to explore this funky fresh language of the early 1980s and the core concepts so masterfully taught by Drs. Abelson and Sussman?

### Part 2: Ocamls and the Eye of the Needle

After this, we will expand our knowledge of functions with OCaml. Ocaml is the most popular ML dialect and its robustness and maintenance by Jane Street developers makes it useful for us to learn in its current use case as a functional programming language in the finance world. We will expand on the ideas taught in the first part, as well as explore what makes Ocaml different from Common Lisp.
