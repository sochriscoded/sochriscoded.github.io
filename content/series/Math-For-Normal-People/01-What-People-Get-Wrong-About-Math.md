+++
draft = false
title = '01 What People Get Wrong About Math' 
series = ['Math From the Very Beginning']
tags = ['Math For Normal People']
[params]
math = true
+++
...
1. Much of our knowledge about math exists because people were willing to be creative, to play around with ideas, and to allow themselves to think.
2. Many of these things are fundamentally true. Because they are logically true, we can arrive to them ourselves if we give ourselves enough space and time.
3. You are not "too stupid" for math. If you are a human, then you are built for math.
4. Allow yourself to play around. Give yourself time to draw with things and be curious about the world around us. That's what really math is about.
